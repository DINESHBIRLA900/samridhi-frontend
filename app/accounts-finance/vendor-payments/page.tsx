    ...
    return (
        <div className="w-full max-w-[1600px] mx-auto">
            ...
            <header className="mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 rounded-2xl bg-white border-2 border-orange-500 p-6 shadow-lg">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Vendor Payments</h2>
                    <p className="text-gray-600 text-sm md:text-base">Track and manage vendor payment records</p>
                </div>
