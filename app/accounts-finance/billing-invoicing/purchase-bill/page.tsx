...
export default function PurchaseBillPage() {
    ...
    const [creditDays, setCreditDays] = useState(30); // Default 30 days
    const [dueDate, setDueDate] = useState("");

    // Mock Bank Accounts (In real app, fetch from API)
    const bankAccounts = [
        { id: '1', name: 'HDFC Bank - XXXXXX1234' },
        { id: '2', name: 'SBI - XXXXXX5678' },
        { id: '3', name: 'ICICI Bank - XXXXXX9012' }
    ];

    // Calculate Due Date when Bill Date or Credit Days change
    useState(() => {
        if (paymentMode === 'credit' && billDate) {
    ...
    // Update due date whenever bill date or credit days change (using effect)
    // Note: The above useState with callback only runs once or needs effect.
    // Let's use clean useEffect.
    ...
    // Update partners list when type changes
    ...
    // Handle partner name change and filter
    ...
    // Refresh after new partner added
        ...
        <div className="w-full max-w-[1600px] mx-auto">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800">Purchase Bill</h1>
                        <p className="text-gray-600 text-sm">Create new purchase bill</p>
                    </div>
                </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 pb-8 border-b border-gray-200">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Vendor Invoice No</label>
                        <input
                            type="text"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            // Read-only if credit logic is enforced, or editable?
                            // User said "days count hoge", so usually calculated.
                            // But maybe editable too.
                            className="w-full px-4 py-3 rounded-xl bg-white border border-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                        />
                    </div>
                </div>
                ...
                <div className="mb-8 pb-8 border-b border-gray-200">
                    {/* Toggle Button for Vendor/Supplier */}
                        ...
                        <div className="flex bg-gray-100 rounded-xl p-1 border border-gray-300 w-full sm:w-auto min-w-[300px]">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    setVendorName("");
                                    setVendorGST("");
                                    // Trigger fetch next render via effect or direct call
                                    ...
                                    <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl max-h-60 overflow-y-auto">
                                        {filteredPartners.map((partner: any) => (
                                            ...
                                            >
                                                ...
                                                {partner.gstin && (
                                                    <span className="text-xs bg-gray-100 px-2 py-1 rounded text-gray-600 group-hover:bg-orange-100 group-hover:text-orange-600">
                                                        Auto-fill
                                                    </span>
                                                )}
                                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (e.target.value !== 'online' && e.target.value !== 'cheque') setBankAccount("");
                            ...
                            {(paymentMode === 'online' || paymentMode === 'cheque') && (
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Select Bank Account {paymentMode === 'cheque' ? '(for Cheque)' : ''}
                                    </label>
                                    <select
                                        value={bankAccount}
                            ...
                            {paymentMode === 'credit' && (
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        Payment pending until: {dueDate || 'Set Bill Date first'}
                                    </p>
                                </div>
                            )}
                            <div>
            ...
            {/* Add Vendor/Supplier Modal - Using BusinessPartnerFormModal */}
