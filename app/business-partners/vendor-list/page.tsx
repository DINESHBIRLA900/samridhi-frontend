        ...
        <div className="w-full max-w-[1600px] mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm mt-6">
                <div className="p-6 border-b border-gray-100 flex flex-col lg:flex-row justify-between items-center gap-4">
                    <h2 className="text-lg font-bold text-gray-800 shrink-0 whitespace-nowrap">Vendor List</h2>
                                ...
                                filteredItems.map(item => (
                                    <tr key={item._id} className="hover:bg-gray-50 transition-colors group">
                                        <td className="py-4 px-6 font-medium text-gray-800">
                                            <a
                                                href={`/business-partners/vendor-list/${item._id}`}
                                        ...
                                        <td className="py-4 px-6 text-right">
                                            <ActionButtons
                                                showView={true}
                                                onView={() => window.location.href = `/business-partners/vendor-list/${item._id}`}
