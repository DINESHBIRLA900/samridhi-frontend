...
import { getVendorById, updateVendor, createVendor } from "@/services/vendorService";
    ...
    const profileSections = [
        {
            ...
            data: [
                ...
                { label: "Branch Type", value: vendor.branch_type },
                { label: "Primary Contact", value: vendor.contact_person },
                { label: "GSTIN", value: vendor.gstin || '-' },
                { label: "Status", value: vendor.status, isStatus: true },
            ]
        },
        {
            ...
            data: [
                { label: "Business Phone", value: vendor.phone },
                { label: "WhatsApp Number", value: vendor.whatsapp_number },
        ...
        },
        {
            ...
            data: [
                { label: "Address Line", value: vendor.address_line || vendor.address },
                { label: "City/Village", value: vendor.village },
                { label: "Tehsil", value: vendor.tehsil },
                { label: "District", value: vendor.district },
    ...
    return (
        <div className="w-full max-w-[1600px] mx-auto p-6 md:p-8 bg-gray-50 min-h-screen">
                    ...
                    <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className={`text-sm font-semibold px-4 py-2 rounded-xl border ${vendor.status === 'Active'
                                ...
                                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow md:col-span-2 lg:col-span-3">
                                    ...
                                    {(!vendor.contact_persons || vendor.contact_persons.length === 0) ? (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            {vendor.contact_persons.map((person: any, index: number) => (
            ...
            <BusinessPartnerFormModal
                ...
                onSave={handleSave}
                type="Vendor"
                service={{ create: createVendor, update: updateVendor }}
            />
        </div>
    );
}
