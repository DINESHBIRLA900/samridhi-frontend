...
import { ArrowLeft, Mail, Phone, MapPin, Building2, Globe, User, Shield, Eye, Pencil, Check, X, Lock } from "lucide-react";
import { toast, Toaster } from 'sonner';
import BusinessPartnerFormModal from "@/components/business-partners/BusinessPartnerFormModal";
import { getSupplierById, updateSupplier, createSupplier } from "@/services/supplierService";
    ...
    const profileSections = [
        {
            ...
            data: [
                ...
                { label: "Branch Type", value: supplier.branch_type },
                { label: "Primary Contact", value: supplier.contact_person },
                { label: "GSTIN", value: supplier.gstin || '-' },
                { label: "Status", value: supplier.status, isStatus: true },
            ]
        },
        {
            ...
            data: [
                { label: "Business Phone", value: supplier.phone },
                { label: "WhatsApp Number", value: supplier.whatsapp_number },
                { label: "Business Email", value: supplier.email },
                { label: "Website", value: supplier.website, isLink: true },
            ]
        },
        {
            ...
            data: [
                { label: "Address Line", value: supplier.address_line || supplier.address },
                { label: "City/Village", value: supplier.village },
                { label: "Tehsil", value: supplier.tehsil },
                    ...
                    <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className={`text-sm font-semibold px-4 py-2 rounded-xl border ${supplier.status === 'Active'
                    ...
                    <div className="relative w-full max-w-6xl bg-white border border-gray-200 rounded-3xl shadow-2xl overflow-hidden my-8">
                        ...
                        <div className="p-6 overflow-y-auto max-h-[80vh] bg-gray-50/30">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow md:col-span-2 lg:col-span-3">
                                    <div className="flex items-center gap-3 mb-5 border-b border-gray-100 pb-4">
                                        ...
                                        <span className="bg-gray-100 text-xs font-bold px-2.5 py-1 rounded-full text-gray-600">
                                            {supplier.contact_persons?.length || 0}
                                        </span>
                                    </div>
                                    ...
                                    {(!supplier.contact_persons || supplier.contact_persons.length === 0) ? (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            {supplier.contact_persons.map((person: any, index: number) => (
