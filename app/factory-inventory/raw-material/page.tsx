    ...
    return (
        <div className="w-full max-w-[1600px] mx-auto p-6 md:p-8 min-h-screen bg-gray-50">
            <PageHeader
                ...
                description="Manage and track raw material inventory levels"
                totalCount={0}
                addButtonLabel="Add Material"
                onAdd={() => console.log('Add Raw Material')}
                showBack={true}
            />
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                <div className="p-6 border-b border-gray-100 flex flex-col lg:flex-row justify-between items-center gap-4">
                    <h2 className="text-lg font-bold text-gray-800 shrink-0 whitespace-nowrap">Material List</h2>
                ...
                <div className="p-12 text-center min-h-[400px] flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">No Raw Materials Found</h3>
                    <p className="text-gray-500 max-w-md">
                        Your raw material inventory will appear here once records are added.
                    </p>
                </div>
            </div>
        </div>
