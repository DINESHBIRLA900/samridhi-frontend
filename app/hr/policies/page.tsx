...
import { Scroll, ShieldAlert, FileText, CheckCircle } from 'lucide-react';
        ...
        <div className="w-full max-w-[1600px] mx-auto p-6 md:p-8 min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                <div className="p-6 border-b border-gray-100 flex flex-col lg:flex-row justify-between items-center gap-4">
                    <h2 className="text-lg font-bold text-gray-800 shrink-0 whitespace-nowrap">Policy List</h2>
                ...
                <div className="p-12 text-center min-h-[400px] flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">No Policies Found</h3>
                    <p className="text-gray-500 max-w-md">
                        Company handbook and workplace rules will be stored here for employee reference.
                    </p>
                </div>
            </div>
        </div>
